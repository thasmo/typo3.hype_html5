...
if(TYPO3_MODE == 'FE') {
	...
	# TSLib Frontend
	$GLOBALS['TYPO3_CONF_VARS']['FE']['XCLASS']['tslib/class.tslib_fe.php'] = t3lib_extMgm::extPath($_EXTKEY, 'Classes/XClass/class.ux_tslib_fe.php');
	...
	# HTML Parser
	$GLOBALS['TYPO3_CONF_VARS']['FE']['XCLASS']['t3lib/class.t3lib_parsehtml.php'] = t3lib_extMgm::extPath($_EXTKEY, 'Classes/XClass/class.ux_t3lib_parsehtml.php');
}
